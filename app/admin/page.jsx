...
const AdminOrdersPage = () => {
  ...
  const calculateTotal = (order) => {
    if (!products[order.productId]) return "Calculating...";

    const subtotal = order.quantity * products[order.productId].price;
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <button
              ...
              className="bg-gray-800 hover:bg-gray-700 cursor-pointer text-white font-bold py-2 px-4 rounded transition duration-150 ease-in-out"
            >
              Refresh Orders
            </button>
          </div>
                ...
                {products[selectedOrder.productId] ? (
                  <div className="flex items-center bg-gray-50 p-4 rounded-md mb-4">
                    <div className="w-20 h-20 mr-4">
                      <img
                        src={products[selectedOrder.productId].imageUrl}
                    ...
                    <div>
                      ...
                      <p>
                        Category: {products[selectedOrder.productId].category}
                      </p>
                      <p>
                        Price: ₵
                        {products[selectedOrder.productId].price.toFixed(2)}
                      </p>
                    </div>
                  </div>
                ) : (
